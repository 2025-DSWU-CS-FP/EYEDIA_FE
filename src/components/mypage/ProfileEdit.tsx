...
export default function ProfileEdit() {
  ...
  return (
    <div className="flex flex-col gap-[2.4rem] px-[2.4rem] py-[4rem]">
      <h2 className="flex flex-col gap-[0.4rem] text-t3 text-gray-80">
      ...
      <div className="flex flex-col gap-[2rem]">
        <section className="flex flex-col gap-[0.8rem]">
          <span className="text-ct4 text-gray-60">닉네임</span>
        ...
        <section className="flex flex-col gap-[0.8rem]">
          <span className="text-ct4 text-gray-60">아이디</span>
          <div className="flex items-start justify-between gap-[0.6rem]">
            <div className="flex flex-[3] flex-col gap-[0.4rem]">
              <TextInput
                id="user-id"
        ...
        <section className="flex flex-col gap-[0.8rem]">
          <span className="text-ct4 text-gray-60">비밀번호</span>
